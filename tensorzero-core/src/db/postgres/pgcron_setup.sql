...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'pg_cron') THEN
        ...
        PERFORM cron.schedule(
            ...
            SELECT tensorzero.drop_old_partitions('chat_inference_io', 'inference_retention_days');
            SELECT tensorzero.drop_old_partitions('json_inference_io', 'inference_retention_days');
            SELECT tensorzero.drop_old_partitions('model_inference_io', 'inference_retention_days');
            $$
        );
