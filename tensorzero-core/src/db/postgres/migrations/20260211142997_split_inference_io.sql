-- Split inference tables into metadata and IO tables.
-- Creates *_io tables (daily partitions) for large payload columns, then drops
...
-- ============================================================================
-- chat_inference_io (daily partitions)
-- ============================================================================

CREATE TABLE tensorzero.chat_inference_io (
    id UUID NOT NULL,
...
SELECT tensorzero.create_partitions('chat_inference_io');

CREATE TABLE tensorzero.chat_inference_io_default
    PARTITION OF tensorzero.chat_inference_io DEFAULT;

-- ============================================================================
-- json_inference_io (daily partitions)
-- ============================================================================

CREATE TABLE tensorzero.json_inference_io (
    id UUID NOT NULL,
    input JSONB NOT NULL,
    output JSONB NOT NULL,
...
SELECT tensorzero.create_partitions('json_inference_io');

CREATE TABLE tensorzero.json_inference_io_default
    PARTITION OF tensorzero.json_inference_io DEFAULT;

-- ============================================================================
-- model_inference_io (daily partitions)
-- ============================================================================

CREATE TABLE tensorzero.model_inference_io (
    id UUID NOT NULL,
...
SELECT tensorzero.create_partitions('model_inference_io');

CREATE TABLE tensorzero.model_inference_io_default
    PARTITION OF tensorzero.model_inference_io DEFAULT;
